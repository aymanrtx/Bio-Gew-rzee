  ...
  return (
    <div>
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-5 md:mt-10  mb-10">
          {blogs?.map((blog) => (
            <div key={blog?._id} className="rounded-md overflow-hidden group mb-8">
              {blog?.mainImage && (
                <Image
              ...
              <div className="bg-gray-100 p-5 pb-6">
